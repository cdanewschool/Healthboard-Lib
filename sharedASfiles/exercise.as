...
[Bindable] public var exerciseData:ArrayCollection = new ArrayCollection([
	...
	{dateProvider: '09/24/2012', date: '09/24/2012', series:"PRTresults", PRTscore: 92, mileRun: 64, curlUps: 55, pushUps: 50, weight: 205, min:13, sec:50, curlTimes:40, pushTimes:24, type: "provider", expectation:'expectation', comments:'', index:4}
]);
...
[Bindable] public var exerciseDataByMeasure:ArrayCollection = new ArrayCollection([
	{ measure: "Avg. PRT Score", chartMin: 35, chartMax: 100,
		chart:[ { data:[{value:56, expectation:45, date:'07/24/2011', type:'provider', measure:'PRTscore'},{value:61, expectation:45, date:'10/11/2011', type:'provider', measure:'PRTscore'},{value:74, expectation:45, date:'11/03/2011', type:'patient', measure:'PRTscore'},{value:81, expectation:45, date:'01/03/2012', type:'patient', measure:'PRTscore'},{value:92, expectation:45, date:'09/24/2012', type:'provider', measure:'PRTscore'}]} ] },
	{ measure: "1.5 Mile Run", chartMin: 35, chartMax: 100,
		chart:[ { data:[{value:62, expectation:45, target:62, targetMin:14, targetSec:40, date:'07/24/2011', type:'provider', measure:'mileRun', min:14, sec:40},{value:63, expectation:45, target:62, date:'10/11/2011', type:'provider', measure:'mileRun', min:14, sec:35},{value:64, expectation:45, target:62, date:'11/03/2011', type:'patient', measure:'mileRun', min:14, sec:30},{value:60, expectation:45, target:62, date:'01/03/2012', type:'patient', measure:'mileRun', min:14, sec:50},{value:62, expectation:45, target:62, date:'09/24/2012', type:'provider', measure:'mileRun', min:14, sec:40}]} ] },
	{ measure: "Curl Ups", chartMin: 35, chartMax: 100,
		chart:[ { data:[{value:80, expectation:45, date:'07/24/2011', type:'provider', measure:'curlUps', times:40},{value:81, expectation:45, date:'10/11/2011', type:'provider', measure:'curlUps', times:40},{value:56, expectation:45, date:'11/03/2011', type:'patient', measure:'curlUps', times:30},{value:50, expectation:45, date:'01/03/2012', type:'patient', measure:'curlUps', times:35},{value:70, expectation:45, date:'09/24/2012', type:'provider', measure:'curlUps', times:40}]} ] },
	{ measure: "Push Ups", chartMin: 35, chartMax: 100,
		chart:[ { data:[{value:92, expectation:45, date:'07/24/2011', type:'provider', measure:'pushUps', times:20},{value:92, expectation:45, date:'10/11/2011', type:'provider', measure:'pushUps', times:20},{value:64, expectation:45, date:'11/03/2011', type:'patient', measure:'pushUps', times:20},{value:55, expectation:45, date:'01/03/2012', type:'patient', measure:'pushUps', times:25},{value:50, expectation:45, date:'09/24/2012', type:'provider', measure:'pushUps', times:24}]} ] }
]);
