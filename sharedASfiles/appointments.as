...
public function populateDatesForWidget():void {
	...
	appointments = new Array({month:"JULY", date: 7, daytime: "THURSDAY 11:00 AM", details: "Nasal Procedure\nDr. Berg\n(999) 999-9999"},
		...
		{month:String(arrMonths[today.getMonth()]).toUpperCase(), date: today.getDate(), daytime: arrWeekdays[today.getDay()] + ' 11:00 AM', details: "Physical Examination\nDr. Berg\n(999) 999-9999"},
		{month:String(arrMonths[new Date(new Date().setDate(myDate.date + daysToAddToReachWednesday[today.getDay()])).getMonth()]).toUpperCase(), date: new Date(new Date().setDate(myDate.date + daysToAddToReachWednesday[today.getDay()])).getDate(), daytime: 'WEDNESDAY 11:00 AM', details: "Physical Therapy\nDr. Berg\n(999) 999-9999"},
		{month:String(arrMonths[new Date(new Date().setDate(myDate.date + daysToAddToReachFriday[today.getDay()])).getMonth()]).toUpperCase(), date: new Date(new Date().setDate(myDate.date + daysToAddToReachFriday[today.getDay()])).getDate(), daytime: 'FRIDAY 9:30 AM', details: "Allergies\nDr. Greenfield\n(999) 999-9999"},
		{month:String(arrMonths[new Date(new Date().setDate(myDate.date + nextWeekButNotWednesday)).getMonth()]).toUpperCase(), date: new Date(new Date().setDate(myDate.date + nextWeekButNotWednesday)).getDate(), daytime: (myDate.getDay() != 3) ? arrWeekdays[myDate.getDay()] + ' 11:30 AM' : 'THURSDAY 11:30 AM', details: "Flu Vaccination\nDr. Berg\n(999) 999-9999"});
