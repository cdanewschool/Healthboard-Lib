...
[Bindable] private var arrMonths:Array = new Array('January','February','March','April','May','June','July','August','September','October','November','December');
private var arrWeekdays:Array = new Array("SUNDAY","MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY");
...
public function getDate(date:String):String {
	...
	var arrMonths:Array = new Array('January','February','March','April','May','June','July','August','September','October','November','December');
	return arrMonths[uint(date.substr(0,2))-1] + ' ' + uint(date.substr(3,2)) + ', ' + date.substr(-4);
}
