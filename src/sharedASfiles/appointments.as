...
public function populateDatesForWidget():void {
	...
	appointments = new Array({month:"JULY", date: 7, daytime: "THURSDAY 11:00 AM", details: "Nasal Procedure\nDr. Berg\n(999) 999-9999"},
		...
		{month:String(Constants.MONTHS[today.getMonth()]).toUpperCase(), date: today.getDate(), daytime: String(Constants.DAYS[today.getDay()]).toUpperCase() + ' 11:00 AM', details: "Physical Examination\nDr. Berg\n(999) 999-9999"},
