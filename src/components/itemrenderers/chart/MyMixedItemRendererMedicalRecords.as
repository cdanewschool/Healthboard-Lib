...
{
	import enum.AppointmentClassificationType;
	...
	public class MyMixedItemRendererMedicalRecords extends CircleItemRenderer
	{
		private static var rcFill:Rectangle = new Rectangle();
		
		private var _data:Object;

		public function MyMixedItemRendererMedicalRecords()
		{
			super();
		}
													  ...
													  unscaledHeight:Number):void
		{
			...
			if( MedicalRecord(data.item).classification == AppointmentClassificationType.OUTPATIENT )
			{
